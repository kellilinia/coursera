...
#    mod_list = [result for result in map(mod, employee_list)]
#    return mod_list
# print(to_mod_list(employee_list))

## ALTERNATIVE SOLUTION WITH TRADITIONAL FOR LOOP:
#    mod_list = []
#    for employee_dict in employee_list:
#        result = mod(employee_dict)
...
def generate_usernames(mod_list):
   ...
   """
   ### WRITE SOLUTION CODE HERE
   return [person.replace(" ", "_") for person in mod_list]
   # raise NotImplementedError()
